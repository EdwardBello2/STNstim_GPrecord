...
% imuData = IMU{:,2:10};
% NOTE: Kiwi's data CANNOT have a sampling rate specified, because her data
% was recorded at times with different sampling rate, and both are here
% included. Later need to resample to make them equally sampled.
