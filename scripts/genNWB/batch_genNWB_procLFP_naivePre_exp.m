...
clear
func_genNWB_procLFP_naivePre_exp('TremoLfpDBS-190927-100155')

clear
func_genNWB_procLFP_naivePre_exp('TremoLfpDBS-191004-100637')

clear
func_genNWB_procLFP_naivePre_exp('TremoLfpDBS-191011-104322')

clear
func_genNWB_procLFP_naivePre_exp('TremoLfpDBS-191018-100615')

clear
func_genNWB_procLFP_naivePre_exp('TremoLfpDBS-191025-104651')

clear
func_genNWB_procLFP_naivePre_exp('TremoLfpDBS-191101-101430')

clear
func_genNWB_procLFP_naivePre_exp('TremoLfpDBS-191108-101829')

clear
func_genNWB_procLFP_naivePre_exp('TremoLfpDBS-191115-100127')


function func_genNWB_procLFP_naivePre_exp(SESSION_ID)
%% CONSTANTS
...
nwbProcSuffix = ['LFP_' elecLabels{ePair(1)} '-' elecLabels{ePair(2)} '_naivePre_exp'];
