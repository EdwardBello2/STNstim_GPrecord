...
clear
tic
func_genNWB_procLFP_washin_exp('TremoLfpDBS-190927-100155')
toc
disp('done with 1 of 8')

clear
tic
func_genNWB_procLFP_washin_exp('TremoLfpDBS-191004-100637')
toc
disp('done with 2 of 8')

clear
tic
func_genNWB_procLFP_washin_exp('TremoLfpDBS-191011-104322')
toc
disp('done with 3 of 8')

clear
tic
func_genNWB_procLFP_washin_exp('TremoLfpDBS-191018-100615')
toc
disp('done with 4 of 8')

clear
tic
func_genNWB_procLFP_washin_exp('TremoLfpDBS-191025-104651')
toc
disp('done with 5 of 8')

clear
tic
func_genNWB_procLFP_washin_exp('TremoLfpDBS-191101-101430')
toc
disp('done with 6 of 8')

clear
tic
func_genNWB_procLFP_washin_exp('TremoLfpDBS-191108-101829')
toc
disp('done with 7 of 8')

clear
tic
func_genNWB_procLFP_washin_exp('TremoLfpDBS-191115-100127')
toc
disp('done with 8 of 8')



function func_genNWB_procLFP_washin_exp(SESSION_ID)
